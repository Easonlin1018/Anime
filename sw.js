const CACHE_VERSION = "anime-tracker-v11-media-review-hotfix-2";
const SHELL = ["./", "./index.html", "./vendor/opencc-js-1.4.1-full.js?v=1.4.1", "./v11-core.js?v=media-review-hotfix-2", "./v11-ui.js?v=media-review-hotfix-2", "./v11-styles.css?v=duplicate-reconciliation-1", "./cross-media.js?v=anime-search-multi-1", "./spotify-config.js", "./spotify-themes.js?v=duplicate-reconciliation-1", "./manifest.webmanifest", "./icons/app-icon.svg"];
