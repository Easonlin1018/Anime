const CACHE_VERSION = "anime-tracker-v11-season-identity-fix-1";
const SHELL = ["./", "./index.html", "./v11-core.js?v=season-identity-fix-1", "./v11-ui.js?v=season-identity-fix-1", "./v11-styles.css?v=duplicate-reconciliation-1", "./cross-media.js?v=anime-search-multi-1", "./spotify-config.js", "./spotify-themes.js?v=duplicate-reconciliation-1", "./manifest.webmanifest", "./icons/app-icon.svg"];
