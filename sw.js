const CACHE_VERSION = "anime-tracker-v11-1";
const SHELL = ["./", "./index.html", "./v11-core.js", "./v11-ui.js", "./v11-styles.css", "./manifest.webmanifest", "./icons/app-icon.svg"];
...
function excluded(url) { return /(supabase|auth\/v1|rest\/v1|cloudflare|worker|sync)/i.test(url.href); }
