const CACHE_VERSION = "anime-tracker-v11-mobile-delete-storage-1";
const SHELL = ["./", "./index.html", "./vendor/opencc-js-1.4.1-full.js?v=1.4.1", "./v11-core.js?v=mobile-delete-storage-1", "./v11-ui.js?v=mobile-delete-storage-1", "./v11-styles.css?v=duplicate-reconciliation-1", "./cross-media.js?v=mobile-delete-storage-1", "./spotify-config.js", "./spotify-themes.js?v=mobile-delete-storage-1", "./manifest.webmanifest", "./icons/app-icon.svg"];
